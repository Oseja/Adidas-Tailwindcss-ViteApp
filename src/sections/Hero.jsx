  ...
  return (
    <div>
      <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container ">
        ...
        <p className="font-montserrat text-lg text-slate-gray leading-8 mt-6 mb-14 sm:max-w-sm:">Discover stlish Nike arrivals, quality, comfort and innovation for your active life.</p>
